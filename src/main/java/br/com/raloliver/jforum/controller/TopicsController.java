...
public class TopicsController {
  ...
  public Page<TopicDto> getAll(
    ...
    @PageableDefault(page = 0, size = 10, sort = "id", direction = Direction.DESC) Pageable pagination
  ) {
  ...
  @PostMapping
  @Transactional
  public ResponseEntity<TopicDto> add(
  ...
  public ResponseEntity<TopicDto> update(
    ...
    @RequestBody @Valid TopicFormUpdate form
  ) {
